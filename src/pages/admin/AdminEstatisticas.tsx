...
export const AdminEstatisticas = () => {
  ...
  const carregarEstatisticas = async () => {
    try {
      ...
      // 6. Tráfego: Total de Visualizações (Tabela: user_tracking_events)
      ...
      // 10. Coleta de Logs de Telemetria do PWA da tabela estatisticas_pwa
      const { data: pwaLogs, error: errPwa } = await supabase
        .from("estatisticas_pwa" as any)
        .select("evento");
      if (errPwa) console.error("Erro ao recuperar logs PWA:", errPwa);
    ...
    <div className="space-y-8 p-1">
      ...
      <div className="pt-2">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-xl border border-border bg-gradient-to-b from-background to-muted/20 shadow-sm p-6 relative overflow-hidden transition-all hover:shadow-md">
            <div className="flex items-center justify-between space-y-0 pb-2">
              <p className="text-sm font-medium text-purple-500 tracking-wide">ACESSOS VIA APP</p>
