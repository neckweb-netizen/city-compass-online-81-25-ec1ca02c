...
import { ArrowLeft, Calculator, Copy, Send, Sparkles, DollarSign, CreditCard, Percent, Check, HelpCircle } from 'lucide-react';
...
export const CalculadoraMargem = () => {
  ...
  // FORMULÁRIO 100% LIMPO (APENAS PLACEHOLDERS)
