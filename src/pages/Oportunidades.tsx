...
import { Briefcase, Wrench, Plus, ArrowRight, Users, Building2 } from 'lucide-react';
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-2xl mx-auto">
              <Button
                asChild
                size="lg"
                className="bg-primary-foreground text-primary hover:bg-primary-foreground/90 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="bg-background text-foreground border-2 border-border hover:bg-muted hover:text-foreground dark:bg-card dark:text-card-foreground dark:border-border dark:hover:bg-accent dark:hover:text-accent-foreground transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
